...
import { ProcessingLog, VideoMeta } from '../types';
...
const ProcessingView: React.FC<ProcessingViewProps> = ({ videoMeta, onComplete }) => {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      currentTick++;
      const newProgress = Math.min(100, (currentTick / steps) * 100);
